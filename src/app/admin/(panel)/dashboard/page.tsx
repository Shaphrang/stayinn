...
export default async function Page() {
  ...
  const [owners, props, rooms, bookings, payments] = await Promise.all([
    getTable("owner_profiles","status" ), getTable("properties","status" ), getTable("property_rooms","id" ), getTable("bookings","status" ), getTable("booking_payments","amount,payment_status" )
  ]);
